...
- **Task 004: shadcn/ui 컴포넌트 설치 및 설정**
  - 필요한 shadcn/ui 컴포넌트 추가 (card, table, badge, separator)
  - 디자인 시스템 색상 팔레트 설정
  - 상태별 배지 스타일 정의 (작성중/발송완료/승인/거절/만료)

- **Task 005: 견적서 컴포넌트 라이브러리 구현**
...
- **Task 006: 견적서 뷰어 페이지 UI 완성**
  - 더미 데이터로 견적서 페이지 구현
  - 반응형 디자인 적용 (모바일/태블릿/데스크톱)
  - 인쇄 친화적 스타일 적용
  - 로딩 스켈레톤 UI 구현

- **Task 007: 에러 페이지 및 홈페이지 UI 구현**
